...
require (
	...
	github.com/crossplane/upjet v1.1.0-rc.0.0.20240131142005-0e52e5d2e629
...
replace github.com/crossplane/upjet => github.com/ulucinar/upbound-upjet v0.0.0-20240131161249-cfc0349f56e2
