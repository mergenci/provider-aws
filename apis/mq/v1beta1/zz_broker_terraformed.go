...
func (tr *Broker) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"ldap_server_metadata[*].service_account_password": "spec.forProvider.ldapServerMetadata[*].serviceAccountPasswordSecretRef", "user[*].password": "spec.initProvider.user[*].passwordSecretRef"}
}
